  ...
  return (
    <div className='p-6 flex flex-col items-center justify-center min-h-screen w-full'>
      <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 mb-4 w-full max-w-5xl mx-auto">
        <DataCard label='Total Views' value={totalSales} name='views'/>
        <DataCard label='Total Interested' value={totalStudents} name="Investors"/>
        <DataCard label='Total Rating' value={totalRevenue} shouldFormat/>
      </div>
