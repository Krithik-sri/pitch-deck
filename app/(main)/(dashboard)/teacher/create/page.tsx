...
function CreateCourse() {
  ...
  return (
    <div className="md:p-6 py-6 md:p-10 bg-secondary/50 text-secondary-foreground md:rounded-3xl container max-w-3xl h-full flex flex-col items-start justify-center">
      <h1 className="font-bold text-xl sm:text-2xl md:text-3xl">Name your Pitch</h1>
      <p className="text-muted-foreground mt-1 text-sm sm:text-base">
        Give a name for your pitch
      </p>
      <Form {...form}>
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input placeholder="e.g. 'A platform for brainstorming ideas'" {...field} />
                </FormControl>
                <FormDescription>
                  Pitch Description
                </FormDescription>
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input placeholder="Krithik Srinivas" {...field} />
                </FormControl>
                <FormDescription>
                  What is your name?
                </FormDescription>
