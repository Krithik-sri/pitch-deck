    ...
    <div className="w-full p-10 lg:p-22  bg-secondary min-h-screen rounded-t-3xl md:rounded-tl-3xl">
      <div className="container max-w-[770px]">
        ...
        {isTeacher(userId) && (
          <div className="flex flex-row items-center justify-between rounded-lg border p-4">
            <div className="space-y-0.5">
              <h3 className="text-base font-semibold">Pitching Account</h3>
              <p>You now have access to submit the pitch</p>
            </div>
            <div>
              <Button asChild>
        ...
        <div className="pb-10">
          ...
          <div className="flex pt-4 gap-4 items-center flex-wrap">
            <Link className={buttonVariants({variant:"outline"})} href={"https://github.com/Krithik-sri"}>Github</Link>
